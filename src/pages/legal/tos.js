...
export default function TestPage ({ user, url }) {
    ...
    const title = `${IsBeta ? 'BETA | ':''}Assistants Center - Terms of Services`
              ...
              >
                <strong>
                  <span style={{ lineHeight: "22.5px", fontSize: 26 }}>
                    ...
                    <bdt className="question">TERMS OF Services</bdt>
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: 15 }}>
              <a data-custom-class="link" href="#disclaimer">
                <span style={{ color: "rgb(89, 89, 89)" }}>16. DISCLAIMER</span>
              </a>
            </span>
          </div>
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: 15 }}>
              <a data-custom-class="link" href="#userdata">
                <span style={{ color: "rgb(89, 89, 89)" }}>19. USER DATA</span>
              </a>
            </span>
          </div>
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <a
                href="https://licenses.assistants.ga/"
                target="_blank"
                data-custom-class="link"
              >
                https://licenses.assistants.ga/
              </a>
            </bdt>{" "}
              ...
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    ...
                    <bdt className="statement-end-if-in-editor" />
                    <bdt className="block-component" />{" "}
                    <bdt className="question">00-001</bdt>
                    <bdt className="statement-end-if-in-editor" />
                  </span>
                </span>
              </span>
          ...
          >
            ...
            >
              ...
              >
                ...
                <bdt className="question">Assistants Center</bdt> and yourself
                both agree to submit to the non-exclusive jurisdiction of the
                courts of <bdt className="question">Warsaw</bdt>, which means
        ...
        >
          ...
          >
            ...
            >
              ...
              Site; (<span style={{ fontSize: "14.6667px" }}>2</span>) breach of
              these Terms of Use; (
          ...
          >
            ...
            >
              <bdt
                ...
                data-type="question"
              >
                <strong>Assistants Center</strong>
              </bdt>
            </span>
          </div>
          <div
              ...
              <strong>
                ...
                >
                  <bdt
                    ...
                    data-type="question"
                  >
                    <strong>assistants.center@gmail.com</strong>
                  </bdt>
                </span>
              </strong>
            </strong>
